 ...
 *
 *=========================================================================*/
#ifndef itkValuedRadiusRegionalExtremaImageFilter_h
#define itkValuedRadiusRegionalExtremaImageFilter_h
...
class ITK_TEMPLATE_EXPORT ValuedRadiusRegionalExtremaImageFilter : public ValuedRegionalExtremaImageFilter<TInputImage, TOutputImage, TFunction1, TFunction2>
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(ValuedRadiusRegionalExtremaImageFilter);

  /** Standard class type aliases. */
  using Self = ValuedRadiusRegionalExtremaImageFilter;
  using Superclass = ValuedRegionalExtremaImageFilter<TInputImage, TOutputImage, TFunction1, TFunction2>;
  ...
  itkTypeMacro(ValuedRadiusRegionalExtremaImageFilter, ValueRegionalExtremaImageFilter);
...
protected:
  ValuedRadiusRegionalExtremaImageFilter();
  ~ValuedRadiusRegionalExtremaImageFilter() override = default;
  void
...
private:
  ...
  using ConstInputIterator = ConstNeighborhoodIterator<InputImageType>;
  using NOutputIterator = NeighborhoodIterator<OutputImageType>;
  using IndexStack = std::stack<OutIndexType>;
}; // end of class
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#  include "itkValuedRadiusRegionalExtremaImageFilter.hxx"
#endif
