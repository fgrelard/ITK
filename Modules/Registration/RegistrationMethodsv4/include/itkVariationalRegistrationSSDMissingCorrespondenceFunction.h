 ...
 *
 *=========================================================================*/
#ifndef itkVariationalRegistrationSSDMissingCorrespondenceFunction_h
#define itkVariationalRegistrationSSDMissingCorrespondenceFunction_h
...
/** \class itk::VariationalRegistrationSSDMissingCorrespondenceFunction
 *
...
class VariationalRegistrationSSDMissingCorrespondenceFunction :
    public VariationalRegistrationFunction< TFixedImage, TMovingImage, TDisplacementField >
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(VariationalRegistrationSSDMissingCorrespondenceFunction);

  /** Standard class type alias. */
  using Self = VariationalRegistrationSSDMissingCorrespondenceFunction;
  ...
  using DivergenceImage = itk::Image<RealType, Superclass::ImageDimension>;
  using DivergenceImagePointer = typename DivergenceImage::Pointer;
  ...
  using NeighborhoodIteratorType = itk::ConstNeighborhoodIterator<DivergenceImage>;
  ...
  * \sa SetTimeStep() */
  ...
  DivergenceImagePointer GetDivergenceImage() const { return m_DivergenceImage;}

  DivergenceImagePointer GetWeightImage() const { return m_WeightImage;}

protected:
  VariationalRegistrationSSDMissingCorrespondenceFunction();
  ~VariationalRegistrationSSDMissingCorrespondenceFunction() override {}
...
private:
  ...
  DivergenceImagePointer          m_DivergenceImage;

  DivergenceImagePointer          m_WeightImage;
};

} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkVariationalRegistrationSSDMissingCorrespondenceFunction.hxx"
#endif
